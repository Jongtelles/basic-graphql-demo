...
const NewsType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    author: {
      ...
      resolve: response =>
        response.author !== null ? response.author : "No author found",
    },
    title: {
      type: GraphQLString,
      args: {
    ...
    summary: {
      ...
      resolve: (response, args) => {
        ...
        return args.lang ? translate(args.lang, summary) : summary;
      },
    },
    url: {
      type: GraphQLString,
  ...
  fields: () => ({
    ...
    transcript: {
      ...
      resolve: (response, args) => {
        ...
        return args.lang ? translate(args.lang, transcript) : transcript;
      },
    },
    img: {
      type: GraphQLString,
    ...
    alt: {
      ...
      resolve: (response, args) => {
        ...
        return args.lang ? translate(args.lang, alt) : alt;
      },
    },
  }),
});
  ...
  query: new GraphQLObjectType({
    ...
    fields: () => ({
      ...
      news: {
        ...
        resolve: (root, args) =>
          news(args.query, args.sortBy, args.from, args.to),
      },
    }),
  }),
});
